...
<?php the_post(); ?>                    
								...
								<h1 class="page-title"><?php _e( 'Category Archives:', 'standardpack' ) ?> <span><?php single_cat_title() ?></span></span></h1>
...
<?php the_excerpt( __( 'Continue reading <span class="meta-nav">&raquo;</span>', 'standardpack' )  ); ?>
                                        ...
                                        <div class="entry-utility">
                                                <?php if ( $cats_meow = sp_cats_meow(', ') ) : // Returns categories other than the one queried ?>
                        <span class="cat-links"><?php printf( __( 'Also posted in %s', 'standardpack' ), $cats_meow ) ?></span>
                        <span class="meta-sep"> | </span>
<?php endif ?>
