<?php get_header(); ?>
                ...
                <div id="container">    
                        <div id="content">
								...
								<h1 class="page-title"><?php _e( 'Tag Archives:', 'standardpack' ) ?> <span><?php single_tag_title() ?></span></h1>
...
<?php the_excerpt( __( 'Continue reading <span class="meta-nav">&raquo;</span>', 'standardpack' )  ); ?>
                                        ...
                                        <div class="entry-utility">
                                                ...
                                                <span class="meta-sep"> | </span>
                                                <?php if ( $tag_ur_it = sp_tag_ur_it(', ') ) : // Returns tags other than the one queried ?>
                        <span class="tag-links"><?php printf( __( 'Also tagged %s', 'standardpack' ), $tag_ur_it ) ?></span>
<?php endif; ?>
