...
<?php if ( have_posts() ) : ?>
                                ...
                                <h1 class="page-title"><?php _e( 'Search Results for: ', 'standardpack' ); ?><span><?php the_search_query(); ?></span></h1>
...
<?php else : ?>
                                ...
                                <div id="post-0" class="post no-results not-found">
                                        <h2 class="entry-title"><?php _e( 'Nothing Found', 'standardpack' ) ?></h2>
                                        <div class="entry-content">
                                                <p><?php _e( 'Sorry, but nothing matched your search criteria. Please try again with some different keywords.', 'standardpack' ); ?></p>
        <?php get_search_form(); ?>                                             
                                        </div><!-- .entry-content -->
                                </div>
