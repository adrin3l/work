                                                    ...
                                                    <div id="bottomfooterwidgetcontainer">
                                                        <div class="bottomfooterwidgety">
                                                                ...
                                                                <div class="footercredit">
																	<?php _e('Powered by ', 'Hazen') ?><a href="http://www.wordpress.org/"><?php _e('WordPress', 'Hazen') ?></a> <?php _e(' | ', 'Hazen') ?><?php _e('Designed by ', 'Hazen') ?><a href="http://www.themealley.com/"><?php _e('ThemeAlley.Com', 'Hazen') ?></a>
                                                                </div>
                                                                <?php else: ?>
                                                                <div class="footercredit">
