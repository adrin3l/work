                        ...
                        <div id="sidebar_section">
                            ...
                            <div id="feed_social">
                                            ...
                                            <div id="sidebar_facebook">
                                            	...
                                            	<p><a href="<?php echo of_get_option('facebook_id'); ?>"><?php _e('Be A Fan On Facebook', 'Hazen') ?></a></p>
                                            ...
                                            <div id="sidebar_twitter">
                                            	...
                                            	<p><a href="http://www.twitter.com/<?php echo of_get_option('twitter_id'); ?>"><?php _e('Follow Us On Twitter', 'Hazen') ?></a></p>                                            
