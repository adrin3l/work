...
?>
	<span class="entry-meta posted-on">
		<span class="sep"><?php _e( 'Posted on', 'swift' ); ?></span>
		<a href="<?php echo esc_url( get_permalink() ); ?>" title="<?php echo esc_attr( get_the_time() ); ?>" rel="bookmark"><time class="entry-date" datetime="<?php echo esc_attr( get_the_date( 'c' ) ); ?>" pubdate="pubdate"><?php echo esc_html( get_the_date() ) ?></time></a>
		<span class="by-author">
			<span class="sep"><?php echo ' '._x( 'by', 'date BY name', 'swift' ).' '; ?></span>
			<span class="author vcard">
				<a class="url fn n" href="<?php echo esc_url( get_author_posts_url( get_the_author_meta( 'ID' ) ) ); ?>" title="<?php printf( esc_attr__( 'View all posts by %s', 'swift' ), get_the_author() ); ?>" rel="author"><?php echo esc_html( get_the_author() ) ?></a>
			</span>
		</span>
	</span>
	<?php
...
?>	<span class="single-entry-meta filed-under"><?php _e( 'Filed under', 'swift' )?> <span class="uppercase"><?php the_category( ', ' )?></span></span>
<?php
...
?>	<span class="single-entry-meta tagged-with"><?php _e( 'Tagged with', 'swift' )?> <span class="uppercase"><h6><?php the_tags('', ', ', ' '); ?></h6></span></span>
<?php
...
<?php
	...
	if (isset ($swift_options['logo']) && $swift_options['logo'] != '') {
		if (is_front_page() || is_home()) {
?>			<h1 id="logo-wrapper">
			<a href="<?php echo home_url(); ?>" title="<?php bloginfo( 'description' ); ?>"><img src="<?php echo $swift_options['logo']?>" alt="<?php bloginfo( 'name' ); ?>" id="logo"  /></a>
			</h1>
<?php
...
?>			<hgroup class="alignleft">
				<h3 id="site-title"><a href="<?php echo esc_url( home_url( '/' ) ); ?>" title="<?php bloginfo( 'name'); ?>" rel="home"><?php bloginfo( 'name' ); ?></a></h2>
				<h4 id="site-description"><?php bloginfo( 'description' ); ?></h3>
			</hgroup>
...
function swift_single_ads($content) {
	...
	if ($swift_is_mobile->isMobile() && !$swift_is_mobile->isTablet()) {
		$swift_options['between_content_ad_enable'] = $swift_options['after_content_ad_enable'] = $swift_options['ads_for_mobile'];
