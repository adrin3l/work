...
$swift_design_options_init[] = array( 'name' => __( 'Blog layout', 'swift' ),
					...
					'default' => 'blog',
					'type' => 'radio',
					'options' => array( 'magazine'=>'magazine', 'magazine-full' => 'magazine-full', 'blog' => 'blog', 'list' => 'list'),
					'datatype' => 'predefined');
...
$swift_design_options_init[] = array( 'name' => __( 'Archives layout', 'swift' ),
					...
					'default' => 'blog',
					'type' => 'radio',
					'options' => array( 'magazine'=>'magazine', 'blog' => 'blog','list'=>'list'),
					'datatype' => 'predefined');
...
$swift_design_options_init[] = array( 'name' => __('Nav link bg', 'swift' ),
					'desc' => '',
					'id' => 'mo_nav_a_bg',
					'default' => '333',
					'type' => 'color',
