...
function swift_set_widths() {
	...
	echo '<div id="width-selector" class="btn btn-success btn-large clearfix">';
	echo '<small style="font-size:12px;float:left"><em>Note: Widths are correct upto one pixel</em></small><h4 class="alignright">Set content and sidebar widths</h4>' .
			'<div class="clear"></div>';
...
<div id="font_demo">
<input type="text" value="SwiftThemes" id="sample_text"><label for="sample_text">Preview text</label>
</div>
<div id="font_preview">
<?php global $current_user;get_currentuserinfo();?>
<h2><?php bloginfo( 'name' ); ?></h2>
<p>Howdy <?php echo $current_user->display_name;?>,<br>
Thank you for purchasing and using Swift on this blog. If you need <strong>any help with WordPress</strong>, feel free to drop me a mail at <strong>satish@swiftthemes.com</strong>.<br>
<img src="<?php echo THEME_URI?>/lib/admin/images/idea.png">Do you know, we can optimize your blog to get <strong>90+ page speed score for only 50$.</strong>
</p>
</div>
<div id="font_optimization">
<button type="button" id="addfont" style="margin-top:-4px" class="btn btn-primary btn-small alignright">Click Me!</button>
<input type="checkbox" name="blogname" value="true" id="blogname"><label for="blogname">For blog name only</label>
<input type="checkbox" name="blogname" value="true" id="tagline"><label for="tagline">For blog tag only</label>
</div>
<?php
	$i=0;
...
<style type="text/css">
#infinite_scroll{height:240px;overflow-y:scroll;margin:0 -20px 20px -20px;border:1px solid #ccc;}
       #infinite_scroll a{font-weight:bold;}
       #infinite_scroll p{margin-bottom:20px;width:90%}
       #infinite_scroll li{padding:15px 10px;border-bottom:dotted 1px #CCC;font-size:24px}
