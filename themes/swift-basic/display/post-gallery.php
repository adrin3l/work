...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<div class="entry-content">
		<div id="nav-above" class="navigation">
			<div class="gallery-nav alignleft"><?php previous_image_link( array(48,48) ); ?></div>
			<div class="gallery-nav alignright"><?php next_image_link( array(48,48) ); ?></div>					
...
?>				
        ...
        <a href="<?php echo wp_get_attachment_url($post->ID); ?>"><?php echo wp_get_attachment_image( $post->ID, array(940,0),false, array('class'=>'gallery-full aligncenter') ); ?></a>
