...
?>
		<header class="entry-header">
				<h4 class="entry-title"><a href="<?php echo $matches[0]; ?>" title="<?php printf( esc_attr__( 'Permalink to %s', 'swift' ), the_title_attribute( 'echo=0' ) ); ?>" rel="bookmark"><?php the_title(); ?></a></h4>
