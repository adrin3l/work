	...
	<?php else : ?>
		...
		<article id="post-0" class="post no-results not-found">
			...
			<div class="entry-content">
				<p><?php _e( 'Apologies, but no results were found for the requested terms. Perhaps searching with slightly different terms will help find a related post.', 'swift' ); ?></p>
				<?php get_search_form(); ?>
			</div><!-- .entry-content -->
		</article><!-- #post-0 -->
