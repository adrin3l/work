...
<div class="div-content clearfix">
	...
	<div class="archive-title">Archives for <h1><?php single_tag_title(); ?></h1></div>
	</div>
</div>
	...
	<?php else : ?>
		...
		<article id="post-0" class="post no-results not-found">
			...
			<div class="entry-content">
				<p><?php _e( 'Apologies, but no results were found for the requested category. Perhaps searching will help find a related post.', 'swift' ); ?></p>
				<?php get_search_form(); ?>
			</div><!-- .entry-content -->
		</article><!-- #post-0 -->
