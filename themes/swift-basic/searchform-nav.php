...
?>
	...
	<input type="text" value="<?php echo $query; ?>" name="s"  onfocus="if (this.value == '<?php echo $query; ?>') {this.value = '';}" onblur="if (this.value == '') {this.value = '<?php echo $query; ?>';}" class="textfield" />
