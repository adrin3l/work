...
define( 'BLOCKS_URL', WP_PLUGIN_URL . '/' . basename( dirname( __FILE__ ) ) );
...
add_action( 'admin_enqueue_scripts', 'posts_blocks_js' );

function posts_blocks_js(){


	 wp_enqueue_script('BLOCKS_URL.js', BLOCKS_URL . '/js/blocks.js');
